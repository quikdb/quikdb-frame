...
print(f"Frame project schema: {len(project_cases)} contract cases passed; build containment, service references, route parity and dependency cycles are additional runtime rules.")
